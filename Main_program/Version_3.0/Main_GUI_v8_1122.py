            ...
            def Finger_up_down(RL_index):
                ...
                for index, function_name in enumerate(finger_list[:5]):
                    if finger_distance[index] > 13:
                        ...
                        function_name.Vision_function(170)  # Hardware Finger Down
...
class Finger_System:
    def __init__(self, text, port, max_value=170):
        # -------- Variable define --------
    ...
    def Change_Color(self, input_value):
        color_number = str(hex(abs((170 - int(input_value)) * 25 // 18)))
...
class Main_GUI:
    ...
    def GUI(self):
        ...
        right_label = tk.Label(self.main_window, text='Authority: ' + Login.user_right,
                               font=('Times', 20, 'bold'))
