...
class Face_recognition:
    ...
    def Encoding_image(self, index):
        ...
        self.Name_list = []
        self.encode_list = []
        path = '../../../Hand Tracking/Main_program/Version_3.0/test_3'
...
class Logout_Create_System:
    ...
    def Create_Account(self):
        ...
        Vision.Start_Vision(self.window, 'Add', 1, 1)
            ...
            def Finger_up_down(RL_index):
                ...
                for index, function_name in enumerate(finger_list[:5]):
                    if finger_distance[index] > 13:
                        ...
                        function_name.Vision_function(130)  # Hardware Finger Down
                    elif finger_distance[index] < -13:
                        finger_detect.append(False)
                        function_name.Vision_function(10)  # Hardware Finger Up
...
class Finger_System:
    ...
    def Scale(self):
        self.sub_scale.configure(from_=0, to=130, font=('Times', 15, 'bold'))
    ...
    def Vision_function(self, input_value):
        ...
        self.sub_scale.set(130 - input_value)
        self.deg.set(130 - input_value)
        self.Change_Color(130 - input_value)
