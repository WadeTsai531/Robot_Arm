...
class Running_time:
    def __init__(self):
        ...
        self.label.place(x=window_x-160, y=window_y-40)
    ...
    def digital_finger(self):
        ...
        if len(my_list) != 0:
            ...
            def Arm_R_L(index):
                x, y = cir(9, index)
                if 100 <= abs(x) <= 500:
                    HR.print_set(int((500-abs(x))*(13/40)))
...
class GUI_module:
    ...
    def label(self):
        ...
        self.Label.place(x=self.x+30, y=self.y)
...
class Hor(GUI_module):
    def __init__(self, x, y, text):
        super().__init__(x, y, text)

    def label(self):
        super().label()
        self.Label.place(x=self.x + 70, y=self.y)
...
Close_button.place(x=window_x-160, y=window_y-80)
...
# ------------- Parameters setup ---------
Fig_1 = GUI_module(670, 25, 'Fig 1')
Fig_2 = GUI_module(820, 25, 'Fig 2')
Fig_3 = GUI_module(970, 25, 'Fig 3')
Fig_4 = GUI_module(1120, 25, 'Fig 4')
Fig_5 = GUI_module(1270, 25, 'Fig 5')
Arm_1 = GUI_module(1420, 25, 'Arm')
HR = Hor(940, 350, 'sdsd')
