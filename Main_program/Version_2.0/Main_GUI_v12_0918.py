...
class Login_system_GUI:
    def __init__(self):
        ...
        self.Login_out_button = tk.Button(window, text='Login', width=7,
                                          font=('Times', 12, 'bold'), command=self.logout)
        self.Login_out_button.place(x=window_x - 100, y=20)

        self.Create_account_button = tk.Button(window, text='Create', width=7,
                                               font=('Times', 12, 'bold'))
        self.Create_account_button.place(x=window_x - 190, y=20)

        self.Delete_button = tk.Button(window, text='Delete', width=7,
                                       font=('Times', 12, 'bold'), state=tk.DISABLED)
        self.Delete_button.place(x=window_x - 100, y=60)
...
connect_frame = tk.Frame(window, relief=tk.RAISED, borderwidth=3)
...
reset_button = tk.Button(window, text='Reset Motor', width=12,
                         font=('Times', 14, 'bold'), command=reset)
