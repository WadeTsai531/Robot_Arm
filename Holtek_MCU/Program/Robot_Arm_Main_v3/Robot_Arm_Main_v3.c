...
void main()
{
	...
	while(1)
	{
		...
		if(Data[0] == 'K')
		{
			for(clear=0;clear<10;clear++)
				Data[clear] = ' ';
			_stm0al = 190; _stm0ah = 0;
			_stm1al = 190; _stm1ah = 0;
			_stm2al = 170; _stm2ah = 0;
			_ptm0al = 190; _ptm0ah = 0;
			_ptm1al = 190; _ptm1ah = 0;
			_ptm2al = 190; _ptm2ah = 0;
...
void servo_setup()
{
	...
	_pt2on = 1; _ptm2al = 190; _ptm2ah = 0;
}
